...
/** Team 3 non-blocking autonomous demonstration. */
@Autonomous(name = "Team 3 Autonomous Demo", group = "Team 3")
public class Team3AutoOpMode extends OpMode {
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Team 3 autonomous initialized");
        telemetry.update();
    }
