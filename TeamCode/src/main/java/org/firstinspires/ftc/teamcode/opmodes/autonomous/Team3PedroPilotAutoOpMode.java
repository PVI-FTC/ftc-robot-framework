...
import org.firstinspires.ftc.teamcode.robots.team3.Team3PedroPathRoute;
import org.firstinspires.ftc.teamcode.robots.team3.Team3PedroPathStep;
import org.firstinspires.ftc.teamcode.robots.team3.Team3PedroRobot;

import java.util.List;

/** Team 3 autonomous path menu using the same controls as the Pedro tuning selector. */
@Autonomous(name = "Team 3 Pedro Paths", group = "Team 3 Testing")
public final class Team3PedroPilotAutoOpMode extends SelectableOpMode {
    public Team3PedroPilotAutoOpMode() {
        super("Select a Team 3 Path", menu -> {
            menu.add(Team3PedroPathRoute.LP11_PILOT.getDisplayName(),
                    () -> new SelectedPathOpMode(Team3PedroPathRoute.LP11_PILOT));
            menu.add(Team3PedroPathRoute.DECODE_ROUTE.getDisplayName(),
                    () -> new SelectedPathOpMode(Team3PedroPathRoute.DECODE_ROUTE));
            menu.add(Team3PedroPathRoute.CURVING_TEST.getDisplayName(),
                    () -> new SelectedPathOpMode(Team3PedroPathRoute.CURVING_TEST));
            menu.add(Team3PedroPathRoute.ILLEGAL_PATH.getDisplayName(),
                    () -> new SelectedPathOpMode(Team3PedroPathRoute.ILLEGAL_PATH));
        });
    }
    ...
    private static final class SelectedPathOpMode extends OpMode {
        ...
        private SelectedPathOpMode(Team3PedroPathRoute route) {
            this.route = route;
        }
        ...
        public void init() {
            ...
            sequence = new AutoSequence(new Team3PedroPathStep(robot, route));
            publishTelemetry();
        }
        ...
        private void publishTelemetry() {
            ...
            telemetry.addData("Application Power", "%.2f",
                    Team3PedroConfiguration.APPLICATION_MAX_POWER);
