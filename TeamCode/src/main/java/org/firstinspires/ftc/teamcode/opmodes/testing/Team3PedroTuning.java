...
import static org.firstinspires.ftc.teamcode.opmodes.testing.Team3PedroTuning.changes;
import static org.firstinspires.ftc.teamcode.opmodes.testing.Team3PedroTuning.drawCurrent;
import static org.firstinspires.ftc.teamcode.opmodes.testing.Team3PedroTuning.drawCurrentAndHistory;
import static org.firstinspires.ftc.teamcode.opmodes.testing.Team3PedroTuning.follower;
import static org.firstinspires.ftc.teamcode.opmodes.testing.Team3PedroTuning.stopRobot;
import static org.firstinspires.ftc.teamcode.opmodes.testing.Team3PedroTuning.telemetryM;
 ...
 * Adapted for Team 3 from the official Pedro Pathing Quickstart at commit
 * d3aea9ca3c5b4c09eded8580229b86996480ee89 (Pedro FTC 2.1.2).
 *
 * @version 1.0, 6/26/2025
 */
@Configurable
@TeleOp(name = "Team 3 Pedro Tuning", group = "Testing")
public class Team3PedroTuning extends SelectableOpMode {
    static final double OFFICIAL_TUNING_MAX_POWER = 1.0;
    public static Follower follower;
    private static Team3PedroTuning activeSelector;
    ...
    public void onSelect() {
        if (follower == null) {
            follower = new Team3PedroFollowerFactory().create(hardwareMap,
                    Team3PedroConfiguration.recordedTeam3Configuration());
 ...
 */
    ...
    public void loop() {
        if (gamepad1.bWasPressed()) {
            stopRobot();
            Team3PedroTuning.requestSelectorStop();
            return;
        }
