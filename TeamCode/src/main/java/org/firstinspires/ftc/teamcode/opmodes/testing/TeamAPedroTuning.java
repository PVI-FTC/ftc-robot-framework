...
import static org.firstinspires.ftc.teamcode.opmodes.testing.TeamAPedroTuning.changes;
import static org.firstinspires.ftc.teamcode.opmodes.testing.TeamAPedroTuning.drawCurrent;
import static org.firstinspires.ftc.teamcode.opmodes.testing.TeamAPedroTuning.drawCurrentAndHistory;
import static org.firstinspires.ftc.teamcode.opmodes.testing.TeamAPedroTuning.follower;
import static org.firstinspires.ftc.teamcode.opmodes.testing.TeamAPedroTuning.stopRobot;
import static org.firstinspires.ftc.teamcode.opmodes.testing.TeamAPedroTuning.telemetryM;
 ...
 * Adapted for Team A from the official Pedro Pathing Quickstart at commit
 * d3aea9ca3c5b4c09eded8580229b86996480ee89 (Pedro FTC 2.1.2).
 *
...
public class TeamAPedroTuning extends SelectableOpMode {
    ...
    public void onSelect() {
        if (follower == null) {
            follower = new TeamAPedroFollowerFactory().create(hardwareMap,
...
/** Ensures the selector's final STOP callback always zeros Team A's drivetrain. */
abstract class TeamAPedroTuningOpMode extends OpMode {
    @Override
    public void stop() {
        TeamAPedroTuning.stopRobot();
    }
}
 ...
 */
class LocalizationTest extends TeamAPedroTuningOpMode {
 ...
 * @version 1.0, 5/6/2024
 */
class ForwardTuner extends TeamAPedroTuningOpMode {
 ...
 */
class LateralTuner extends TeamAPedroTuningOpMode {
    public static double DISTANCE = 48;
 ...
 * @version 1.0, 5/6/2024
 */
class TurnTuner extends TeamAPedroTuningOpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralVelocityTuner extends TeamAPedroTuningOpMode {
    private final ArrayList<Double> velocities = new ArrayList<>();
 ...
 * @version 1.0, 3/13/2024
 */
class ForwardZeroPowerAccelerationTuner extends TeamAPedroTuningOpMode {
 ...
 * @version 1.0, 3/13/2024
 */
class LateralZeroPowerAccelerationTuner extends TeamAPedroTuningOpMode {
    private final ArrayList<Double> accelerations = new ArrayList<>();
    public static double VELOCITY = 30;
    private double previousVelocity;
    private long previousTimeNano;
 ...
 */
class PredictiveBrakingTuner extends TeamAPedroTuningOpMode {
        ...
        switch (state) {
            ...
            case DONE: {
                ...
                for (BrakeRecord record : brakeData) {
                    Pose p = record.pose;
                    telemetryM.debug(String.format("t=%.0f ms, x=%.2f, y=%.2f, heading=%.2f, v=%.2f",
 ...
 */
class TranslationalTuner extends TeamAPedroTuningOpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class HeadingTuner extends TeamAPedroTuningOpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class DriveTuner extends TeamAPedroTuningOpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/12/2024
 */
class Line extends TeamAPedroTuningOpMode {
    public static double DISTANCE = 40;
    private boolean forward = true;
 ...
 * @version 1.0, 3/13/2024
 */
class CentripetalTuner extends TeamAPedroTuningOpMode {
 ...
 */
class Triangle extends TeamAPedroTuningOpMode {
 ...
 * @version 1.0, 3/12/2024
 */
class Circle extends TeamAPedroTuningOpMode {
 ...
 */
class OffsetsTuner extends TeamAPedroTuningOpMode {
    @Override
    public void init() {
        follower.setStartingPose(new Pose(72,72));
        follower.update();
