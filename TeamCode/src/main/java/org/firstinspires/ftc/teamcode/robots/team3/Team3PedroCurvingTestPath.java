...
/** Team 3 curving test path. */
final class Team3PedroCurvingTestPath {
    private Team3PedroCurvingTestPath() {
    }

    static PathChain build(Follower follower) {
        if (follower == null) {
            throw new IllegalArgumentException("The Team 3 curving test needs a Pedro follower.");
        }
